...
$Executar_cadastro = new Mostrar_noticias();
...
<form class="login100-form" method="POST" enctype="multipart/form-data">
    <div class="container">
        ...
        <input type="text" name="titulo" class="form-control"  value="<?=utf8_encode($Executar_cadastro->titulo)?>">
        <div class="input-group-prepend">
            <span class="input-group-text" id="">Indrodução</span>
        </div>
        <input type="text" class="form-control" name="text_area" value="<?=utf8_encode($Executar_cadastro->text_area)?>">
